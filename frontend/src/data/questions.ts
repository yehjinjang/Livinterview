...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["한달에 1~2회 이상", "분기 별로 1~2회", "거의 안가요"],
  },
  // -MARK: 자연
  {
    id: "5-mountain",
    category: "자연",
    title: "집 근처에 산이 있으면 어떠신가요?",
    type: "radio",
    icon: "/icons/report/green/mountain.svg",
    options: [
      "전혀 필요 없다(거의 안 간다)",
      "별로 상관없다",
      "보통이다",
  ...
  },
  {
    id: "5-river",
    category: "자연",
    title: "집 근처에 한강이 있으면 더 좋다고 느끼시나요?",
    type: "radio",
    icon: "/icons/report/green/river.svg",
    options: [
      "전혀 신경 안 쓴다",
      "별로 중요하지 않다",
      "보통이다",
  ...
  },
  {
    id: "5-stream",
    category: "자연",
    title: "집 근처에 하천이 있으면 더 좋다고 느끼시나요?",
    type: "radio",
  ...
  },
  {
    id: "5-park",
    category: "자연",
    title: "집 근처에 공원이 있으면 더 좋다고 느끼시나요?",
    type: "radio",
    icon: "/icons/report/green/park.svg",
    options: [
      "전혀 신경 안 쓴다",
      "별로 중요하지 않다",
      "보통이다",
  ...
  },
  {
    id: "7-internetcafe",
    category: "놀이",
    title: "PC방을 얼마나 자주 가시나요?",
    type: "radio",
    icon: "/icons/report/play/pcroom.svg",
    options: [
      "거의 안 간다 (한 달에 1~2번 이하)",
      "가끔 간다 (일주일 1회 이하)",
      "보통이다 (일주일 2~3회)",
